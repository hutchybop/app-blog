...
module.exports.register = (req, res) => {
    res.render('users/register', { title: 'Register at hutchybop.co.uk', page: 'Users' })
}
...
module.exports.login = (req, res) => {
    res.render('users/login', { title: 'Login to hutchybop.co.uk', page: 'Users' });
}
...
module.exports.forgotPost = async (req, res) => {
    ...
    const successMessage = 'If an account with that email address exists, a password reset link has been sent.';
...
module.exports.reset = async (req, res) => {
    ...
    if (!foundUser) {
        req.flash('error', 'Password reset token is invalid, has been used, or has expired.');
        return res.redirect('/forgot');
    }
    
    res.render('users/reset', {token: req.params.token, title: 'Reset Your Password', page: 'Reset'});
...
module.exports.details = (req, res) => {
    ...
    res.render('users/details', {username, email, title: 'Reset Your Email Adrress', page: 'Details'});
}
...
module.exports.deletePre = (req, res) => {
    ...
    if(req.user.username != "defaultMeals" && req.user.username != "anonymous"){
        ...
        res.render('users/deletepre', {user, title: 'Confirm DELETE account', page: 'Delete'});
