module.exports.tnc = `Welcome to hutchybop!

These terms and conditions outline the rules and regulations for the use of hutchybop's
Website, located at www.hutchybop.co.uk.

By accessing this website we assume you accept these terms and conditions. Do not continue
to use hutchybop if you do not agree to take all of the terms and conditions stated on this
page.
...
We employ the use of cookies. By accessing hutchybop, you agreed to use cookies in agreement
with the hutchybop's Privacy Policy.
...
Unless otherwise stated, hutchybop and/or its licensors own the intellectual property rights
for all material on hutchybop. All intellectual property rights are reserved. You may access
this from hutchybop for your own personal use subjected to restrictions set in these terms
and conditions.

You must not:

Republish material from hutchybop
Sell, rent or sub-license material from hutchybop
Reproduce, duplicate or copy material from hutchybop
Redistribute content from hutchybop
...
information in certain areas of the website. hutchybop does not filter, edit, publish or
review Comments prior to their presence on the website. Comments do not reflect the views
and opinions of hutchybop,its agents and/or affiliates. Comments reflect the views and
opinions of the person who post their views and opinions. To the extent permitted by
applicable laws, hutchybop shall not be liable for the Comments or for any liability,
damages or expenses caused and/or suffered as a result of any use of and/or posting of
and/or appearance of the Comments on this website.

hutchybop reserves the right to monitor all Comments and to remove any Comments which can be
considered inappropriate, offensive or causes breach of these Terms and Conditions.

External hyperlinking in comments will not be allowed and hutchybop reserves the right to 
remove any such comments or reviews containing external hyperlinks.
...
You hereby grant hutchybop a non-exclusive license to use, reproduce, edit and authorize
...
visibility of the hyperlink compensates the absence of hutchybop; and (d) the link is in the
...
linking to our website, you must inform us by sending an e-mail to hutchybop. Please include
...
No use of hutchybop's logo or other artwork will be allowed for linking absent a trademark
license agreement.
