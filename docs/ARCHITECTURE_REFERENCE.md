# Architecture Reference - hutchybop Blog Application

## 1. System Overview

This is a Node.js/Express blog application built for hutchybop.co.uk, featuring user authentication, content management, and an interactive review system. The application serves as an Ironman training blog where users can read posts, leave reviews, and manage their accounts.
